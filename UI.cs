        ...
        public void TopMenu() {
            ...
            switch(input) {
                ...
                case "1":
                    ...
                    //PSEUDOCODE:
                    //Need to run a loop for the ids and addresses of all car dealers through the this.CarDealers attribute
                    //Need to access GetAddress() method from this.CarDealers attribute
                    //Using foreach loop, print all of the ids and addresses that are identified by the loop
